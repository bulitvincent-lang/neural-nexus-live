...
export const SITE = {
  ...
  releaseBase: "https://github.com/bulitvincent-lang/neural-orb/releases/latest/download",
  releasesPage: "https://github.com/bulitvincent-lang/neural-orb/releases/latest",
  version: "0.1.0",
  /**
